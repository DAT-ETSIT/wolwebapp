...
const loadTheme = (theme) => {
    ...
    let canvas = document.getElementById("logoCaronte");
    try{
    ...
    if(theme === "dark"){
        ...
        canvas.style.backgroundImage = "url('https://i.imgur.com/IJiS2lE.png')";
        try{
        ...
        canvas.style.backgroundImage = "url('https://i.imgur.com/OSH2ms4.png')";
        try{
